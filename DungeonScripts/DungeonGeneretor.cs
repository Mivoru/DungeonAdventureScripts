...
public class DungeonGenerator : MonoBehaviour
{
    ...
    public int minCorridorWidth = 3; // DoporuËuji lichÈ ËÌslo
    public int maxCorridorWidth = 5;
    public int minCorridorLength = 8;
    public int maxCorridorLength = 16;

    [Header("Wall Height Logic")]
    public int verticalPadding = 6; // MÌsto pro vysokÈ zdi p¯i generov·nÌ
    ...
    public TileBase wallMid;     // WallBase2 (St¯ed)
    public TileBase wallHigh;    // WallBase3 (Vröek)
    public TileBase wallRoof;    // WallBTop (St¯echa)

    [Header("Shadow Settings")]
    public Tilemap ShadowMap;
    public TileBase floorShadow; // Sem dej ten Rule Tile
    public TileBase wallShadow;  // Sem dej ten pln˝ Ëern˝ Ëtverec (Full Shadow)

    [Header("Spawn Room (Start)")]
    public Vector2Int spawnRoomSize = new Vector2Int(10, 10); // FixnÌ velikost 10x10
    ...
    [HideInInspector] public int enemyCount = 0; // Legacy promÏnn·

    [Header("References")]
    public Tilemap Ground;
    public Tilemap Walls;
    public TileBase FloorTile;
    public TileBase WallTile; // WallBase1 (Spodek s kolizÌ)
